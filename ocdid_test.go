...
var (
	...
	expectedURI           = "/elections/upcoming?district-divisions=ocd-division/country:us/state:ca,ocd-division/country:us/state:ca/place:sunnydale"
)
...
func TestGetUpcomingElections(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(rw http.ResponseWriter, req *http.Request) {
		if req.RequestURI != expectedURI {
			t.Errorf("Mock http server expected request to have URI %s but got %s", req.RequestURI, expectedURI)
		}
